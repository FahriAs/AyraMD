...
handler.all = async function (m) {
    ...
    let uptime = clockString(_uptime)
       ...
       global.fetch = import('node-fetch')
		...
		global.kontak2 = [
         [owner[0], await this.getName(owner[0] + '628893729854@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'fahrixzofficial@mail.com', true],
         [owner[1], await this.getName(owner[1] + '6285769727113@s.whatsapp.net'), 'ᴅᴇᴠᴇʟᴏᴩᴇʀ ʙᴏᴛ', 'fahrixzofficial@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					sourceUrl: "https://www.youtube.com/@ZykoBotzMD",					
				}
			}
		}
		global.fakeig = {
